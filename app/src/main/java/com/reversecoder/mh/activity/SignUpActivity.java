...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void initRegistrationUI() {
        ...
        if (NetworkManager.isConnected(SignUpActivity.this)) {
            ...
            if (AppUtils.isNullOrEmpty(SessionManager.getStringSetting(SignUpActivity.this, SESSION_CITY_WITH_COUNTRY))) {
                SessionManager.setStringSetting(SignUpActivity.this, SESSION_CITY_WITH_COUNTRY, AllConstants.getDefaultCountryData());
            }
...
//                Toast.makeText(SignUpActivity.this, item.getName(), Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(HttpRequestManager.HttpResponse result) {
            ...
            if (result.isSuccess() && !AppUtils.isNullOrEmpty(result.getResult().toString())) {
                ...
                if ((responseData.getStatus().equalsIgnoreCase("1")) && (responseData.getUser_details().size() == 1)) {
                    ...
                    SessionManager.setStringSetting(SignUpActivity.this, SESSION_USER_DATA, responseData.getUser_details().get(0).toString());
    ...
    private void setSpinnerData() {
        wrapperCityWithCountryData = ResponseCountry.getResponseObject(SessionManager.getStringSetting(SignUpActivity.this, SESSION_CITY_WITH_COUNTRY), ResponseCountry.class);
