...
import com.reversecoder.mh.model.ResponseUserData;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void initUpdateProfileUI() {
        ...
        if (!AppUtils.isNullOrEmpty(SessionManager.getStringSetting(ProfileActivity.this, SESSION_USER_DATA))) {
            Log.d(TAG, "Session data: " + SessionManager.getStringSetting(ProfileActivity.this, SESSION_USER_DATA));
            user = UserData.getResponseObject(SessionManager.getStringSetting(ProfileActivity.this, SESSION_USER_DATA), UserData.class);

            if (NetworkManager.isConnected(ProfileActivity.this)) {
                new GetCityWithCountry(ProfileActivity.this).execute();
            } else {
                if (AppUtils.isNullOrEmpty(SessionManager.getStringSetting(ProfileActivity.this, SESSION_CITY_WITH_COUNTRY))) {
                    SessionManager.setStringSetting(ProfileActivity.this, SESSION_CITY_WITH_COUNTRY, AllConstants.getDefaultCountryData());
                }

                wrapperCityWithCountryData = ResponseCountry.getResponseObject(SessionManager.getStringSetting(ProfileActivity.this, SESSION_CITY_WITH_COUNTRY), ResponseCountry.class);
        ...
        protected void onPostExecute(HttpRequestManager.HttpResponse result) {
            ...
            if (result.isSuccess() && !AppUtils.isNullOrEmpty(result.getResult().toString())) {
                ...
                if ((responseData.getStatus().equalsIgnoreCase("1")) && (responseData.getUser_details().size() == 1)) {
                    ...
                    SessionManager.setStringSetting(ProfileActivity.this, SESSION_USER_DATA, responseData.getUser_details().get(0).toString());
