...
import com.rc.abovesound.adapter.StateListAdapter;
...
import com.rc.abovesound.model.ResponseMusicCategory;
...
public class ZoneActivity extends AppCompatActivity {
    ...
    private void initZoneUI() {
        ...
        if (intent.getBooleanExtra(AllConstants.KEY_INTENT_EXTRA_ZONE, false)) {
            isFromMenu = intent.getBooleanExtra(AllConstants.KEY_INTENT_EXTRA_ZONE, false);
        }
    ...
    private void setDefaultCityWithCountry() {
        if (AppUtils.isNullOrEmpty(SessionManager.getStringSetting(ZoneActivity.this, AllConstants.SESSION_CITY_WITH_COUNTRY))) {
            SessionManager.setStringSetting(ZoneActivity.this, AllConstants.SESSION_CITY_WITH_COUNTRY, AllConstants.getDefaultCountryData());
        }
    }

    private void setDefaultMusicCategory() {
        if (AppUtils.isNullOrEmpty(SessionManager.getStringSetting(ZoneActivity.this, AllConstants.SESSION_MUSIC_CATEGORY))) {
            SessionManager.setStringSetting(ZoneActivity.this, AllConstants.SESSION_MUSIC_CATEGORY, AllConstants.getDefaultMusicCategoryData());
        }
    }
    ...
    private void initZoneAction() {
        ...
        llPst.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SessionManager.setStringSetting(ZoneActivity.this, AllConstants.SESSION_SELECTED_ZONE, zones[0]);
                strTimeZone = SessionManager.getStringSetting(ZoneActivity.this, AllConstants.SESSION_SELECTED_ZONE);
        ...
        llMst.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SessionManager.setStringSetting(ZoneActivity.this, AllConstants.SESSION_SELECTED_ZONE, zones[1]);
                strTimeZone = SessionManager.getStringSetting(ZoneActivity.this, AllConstants.SESSION_SELECTED_ZONE);
        ...
        llCst.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SessionManager.setStringSetting(ZoneActivity.this, AllConstants.SESSION_SELECTED_ZONE, zones[2]);
                strTimeZone = SessionManager.getStringSetting(ZoneActivity.this, AllConstants.SESSION_SELECTED_ZONE);
        ...
        llEst.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SessionManager.setStringSetting(ZoneActivity.this, AllConstants.SESSION_SELECTED_ZONE, zones[3]);
                strTimeZone = SessionManager.getStringSetting(ZoneActivity.this, AllConstants.SESSION_SELECTED_ZONE);
...
//        dialog.getWindow().getAttributes().windowAnimations = R.style.DialogAnimation_left_right;
        ...
        if (SessionManager.getStringSetting(ZoneActivity.this, AllConstants.SESSION_CITY_WITH_COUNTRY) != null) {
            wrapperCityWithCountryData = ResponseCountry.getResponseObject(SessionManager.getStringSetting(ZoneActivity.this, AllConstants.SESSION_CITY_WITH_COUNTRY), ResponseCountry.class);
        ...
        btnSuccessOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (stateAdapter.isAnyItemSelected()) {
                    SessionManager.setStringSetting(ZoneActivity.this, AllConstants.SESSION_SELECTED_CITY, ((City) stateAdapter.getSelectedItem()).getName());
    ...
    private void goNext() {
        ...
        if (isFromMenu) {
            ...
            intentNext.putExtra(AllConstants.KEY_INTENT_EXTRA_ZONE, true);
        ...
        protected void onPostExecute(HttpRequestManager.HttpResponse result) {
            if (result.isSuccess() && !AppUtils.isNullOrEmpty(result.getResult().toString())) {
                ...
                if ((responseData.getStatus().equalsIgnoreCase("1")) && (responseData.getData().size() > 0)) {
                    ...
                    SessionManager.setStringSetting(mContext, AllConstants.SESSION_MUSIC_CATEGORY, modifiedMusicCategory);
                    Log.d(TAG, "success response from session: " + SessionManager.getStringSetting(mContext, AllConstants.SESSION_MUSIC_CATEGORY));
                } else {
                    setDefaultMusicCategory();
                    Toast.makeText(ZoneActivity.this, getResources().getString(R.string.toast_no_info_found), Toast.LENGTH_SHORT).show();
                }
